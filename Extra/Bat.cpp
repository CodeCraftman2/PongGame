...
Bat::Bat(float startX, float startY)
{
	...
	m_Speed = 600.0f; // Increased speed
}
...
void Bat::increaseSpeed(float increment) {
    m_Speed += increment; // Increase bat speed by the given increment
}
